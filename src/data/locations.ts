...
export const locationDefinitions: LocationDefinition[] = [
  ...
  },
  {
    ...
    quests: [
      ...
      { name: 'Scheduled for Execution', leveled: 30 },
      { name: 'To Serve Sithis' },
      { name: 'The Assassinated Man', leveled: 30 },
      { name: "My Brother's Keeper" },
      { name: 'The Lonely Wanderer', leveled: 30 },
      { name: 'Enter the Eliminator' },
      { name: 'Bad Medicine', leveled: 30 },
      { name: "The Night Mother's Child" },
      { name: 'Whodunit?' },
      { name: "The Assassin's Gambit" },
      { name: 'Permanent Retirement' },
      { name: 'Of Secret And Shadow' },
      { name: 'The Purification' },
      { name: 'The Dead Drop' },
      { name: 'Affairs of a Wizard' },
      { name: 'Next of Kin' },
      { name: 'Broken Vows' },
      { name: 'Final Justice' },
      ...
      { name: 'Honor Thy Mother', leveled: 30 },
  ...
  },
  {
    ...
    quests: [
      ...
      { name: "Ahdarji's Heirloom" },
      { name: 'The Unbeaten Path' },
      { name: 'Drunk and Disorderly' },
      { name: 'The Fugitives' },
      { name: 'Black Bow Bandits' },
      { name: 'Raid on Greyland' },
  ...
  },
  {
    ...
    hold: 'Heartlands',
    initiallyDiscovered: false,
    quests: [{ name: "Newheim's Flagon" }, { name: 'Go Fish' }],
  ...
  },
  {
    ...
    hold: 'Nibenay Valley',
    initiallyDiscovered: false,
    quests: [{ name: 'Order of the Virtuous Blood', leveled: 25 }, { name: 'Raid on Greyland' }],
  },
  {
  ...
  },
  {
    ...
    hold: 'Nibenay Basin',
    initiallyDiscovered: false,
    quests: [{ name: 'Infiltration' }, { name: 'The Potato Snatcher' }],
  },
  {
  ...
  },
  {
    ...
    hold: 'Nibenay Basin',
    initiallyDiscovered: false,
    quests: [{ name: 'No Stone Unturned' }, { name: "The Noble's Daughter" }],
  ...
  },
  {
    ...
    hold: 'West Weald',
    initiallyDiscovered: false,
    quests: [{ name: 'No Rest for the Wicked' }],
    nirnroots: [
  ...
  },
  {
    ...
    hold: 'Heartlands',
    initiallyDiscovered: false,
    quests: [{ name: 'Unfinished Business' }, { name: 'Blade Training' }],
  ...
  },
  {
    ...
    hold: 'Nibenay Valley',
    initiallyDiscovered: false,
    quests: [{ name: 'No Stone Unturned' }, { name: 'No Rest for the Wicked' }],
  ...
  },
  {
    ...
    hold: 'Heartlands',
    initiallyDiscovered: false,
    quests: [{ name: 'A Venerable Vintage' }, { name: 'Heavy Armor Training' }],
  ...
  },
  {
    ...
    hold: 'Nibenay Basin',
    initiallyDiscovered: false,
    quests: [{ name: 'Tears of the Savior' }, { name: 'The Horror of Dive Rock' }],
  ...
  {
    id: 'wayshrine-of-kynareth',
    name: 'Wayshrine of Kynareth',
    type: 'Landmark',
    hold: 'Great Forest',
    initiallyDiscovered: false,
    quests: [{ name: 'Destruction Training' }],
    trainers: [{ name: 'Bralsa Andaren', skill: 'Destruction', tier: 'Master', maxLevel: 100 }],
  },
  ...
  },
  {
    ...
    hold: 'Nibenay Valley',
    initiallyDiscovered: false,
    quests: [{ name: 'Lich of Lost Boy Cavern' }],
  },
  {
    id: 'memorial-cave',
    name: 'Memorial Cave',
  ...
  },
  {
    ...
    hold: 'Blackwood',
    initiallyDiscovered: false,
    quests: [{ name: 'Drunk and Disorderly' }, { name: 'The Fugitives' }],
  },
  {
    id: 'unmarked-cave',
    name: 'Unmarked Cave',
  ...
  },
  {
    ...
    hold: 'Nibenay Valley',
    initiallyDiscovered: false,
    quests: [{ name: 'Caught in the Hunt' }, { name: "The Noble's Daughter" }],
  ...
  },
  {
    ...
    hold: 'Nibenay Valley',
    initiallyDiscovered: false,
    quests: [{ name: 'The Wayward Knight', leveled: 25 }, { name: 'Alteration Training' }],
    trainers: [{ name: 'Tooth-in-the-Sea', skill: 'Alteration', tier: 'Master', maxLevel: 100 }],
  },
  {
    id: 'forsaken-mine',
    name: 'Forsaken Mine',
